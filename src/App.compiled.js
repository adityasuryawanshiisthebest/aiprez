...
function normalizeGeneratedDeck(deck) {
  var output = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  var prompt = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
  if (!deck || !Array.isArray(deck.slides)) return null;
  var tones = ["cover", "split", "timeline", "map", "comparison", "data", "quote", "gallery"];
  return {
    title: cleanMarkdownText(deck.title) || cleanMarkdownText(prompt).split(/[.!?]/)[0] || "Generated Presentation",
    subtitle: cleanMarkdownText(deck.subtitle),
    visualTheme: cleanMarkdownText(deck.visualTheme),
    themeName: cleanMarkdownText(deck.themeName),
    themePalette: Array.isArray(deck.themePalette) ? deck.themePalette.slice(0, 5) : [],
    checkingReport: deck.checkingReport || null,
    slides: deck.slides.map(function (slide, index) {
      return {
        number: Number(slide.number) || index + 1,
        templateId: cleanMarkdownText(slide.templateId),
        title: cleanMarkdownText(slide.title) || "Slide ".concat(index + 1),
        subtitle: cleanMarkdownText(slide.subtitle) || "Generated by AIPREZ AI",
        bullets: Array.isArray(slide.bullets) ? slide.bullets.map(cleanMarkdownText).filter(Boolean).slice(0, 7) : [],
        previewBullets: Array.isArray(slide.previewBullets) ? slide.previewBullets.map(cleanMarkdownText).filter(Boolean).slice(0, 5) : [],
        speakerNotes: cleanMarkdownText(slide.speakerNotes),
        visualDirection: cleanMarkdownText(slide.visualDirection),
        picturePrompt: cleanMarkdownText(slide.picturePrompt),
        imageDataUrl: slide.imageDataUrl || "",
        imageError: cleanMarkdownText(slide.imageError),
        layout: cleanMarkdownText(slide.layout) || tones[index % tones.length],
        palette: Array.isArray(slide.palette) && slide.palette.length ? slide.palette.slice(0, 5) : Array.isArray(deck.themePalette) ? deck.themePalette.slice(0, 5) : [],
        thumb: cleanMarkdownText(slide.title) || "Slide ".concat(index + 1),
        tone: tones[index % tones.length]
      };
    }),
    raw: output || JSON.stringify(deck)
  };
}
function parseGeneratedPresentation(output) {
  var prompt = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  var deckPayload = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  var normalizedDeck = normalizeGeneratedDeck(deckPayload, output, prompt);
  if (normalizedDeck) return normalizedDeck;
  ...
  var slides = slideMatches.map(function (match, index) {
    ...
    return {
      ...
      subtitle: bullets[0] || speakerNotes || "Generated by AIPREZ AI",
  ...
  return {
    ...
    slides: slides.length ? slides : [{
      number: 1,
      title: title,
      subtitle: "Generated by AIPREZ AI",
      bullets: cleanMarkdownText(output).split(/\n+/).filter(Boolean).slice(0, 4),
      speakerNotes: "",
      imageDataUrl: "",
      picturePrompt: "",
      layout: "cover",
...
function GeneratedSlideVisual(_ref22) {
  var slide = _ref22.slide;
  if (slide !== null && slide !== void 0 && slide.imageDataUrl) {
    return /*#__PURE__*/React.createElement("div", {
      className: "generated-slide-image",
      "aria-hidden": "true"
    }, /*#__PURE__*/React.createElement("img", {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "generated-slide-visual ".concat((slide === null || slide === void 0 ? void 0 : slide.tone) || "cover"),
    "aria-hidden": "true"
  }, /*#__PURE__*/React.createElement("span", {
...
function PresentationPreview(_ref23) {
  var _slide$previewBullets, _slide$palette, _slide$palette2, _slide$palette3;
  ...
  var slides = (generatedDeck === null || generatedDeck === void 0 ? void 0 : generatedDeck.slides) || [];
  var slide = slides[activeSlide] || slides[0];
  var visibleBullets = slide !== null && slide !== void 0 && (_slide$previewBullets = slide.previewBullets) !== null && _slide$previewBullets !== void 0 && _slide$previewBullets.length ? slide.previewBullets : (slide === null || slide === void 0 ? void 0 : slide.bullets) || [];
  var visibleStart = slides.length > 4 ? Math.min(Math.max(activeSlide - 1, 0), slides.length - 4) : 0;
  var visibleSlides = slides.slice(visibleStart, visibleStart + 4);
  React.useEffect(function () {
    setActiveSlide(0);
  }, [generatedDeck === null || generatedDeck === void 0 ? void 0 : generatedDeck.raw]);
  if (!generatedDeck || !slide) {
    return /*#__PURE__*/React.createElement("section", {
  ...
  return /*#__PURE__*/React.createElement("section", {
    className: "preview-panel glass generated-preview-panel"
  }, /*#__PURE__*/React.createElement("h3", null, "Presentation Preview"), /*#__PURE__*/React.createElement("div", {
    className: "upload-row generated-upload-row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ppt-icon"
  }, "AI"), /*#__PURE__*/React.createElement("strong", null, generatedDeck.title), /*#__PURE__*/React.createElement("span", {
    className: "uploaded-pill"
  }, "Generated ", /*#__PURE__*/React.createElement(Icon, {
    icon: CheckCircle,
    size: 15,
    strokeWidth: 1.8
  }))), /*#__PURE__*/React.createElement("div", {
    className: "main-slide generated-main-slide ".concat(slide.tone, " ").concat(slide.imageDataUrl ? "has-image" : ""),
    style: {
      "--slide-accent-a": ((_slide$palette = slide.palette) === null || _slide$palette === void 0 ? void 0 : _slide$palette[0]) || "#ff4f75",
      "--slide-accent-b": ((_slide$palette2 = slide.palette) === null || _slide$palette2 === void 0 ? void 0 : _slide$palette2[1]) || "#ffbd3a",
      "--slide-accent-c": ((_slide$palette3 = slide.palette) === null || _slide$palette3 === void 0 ? void 0 : _slide$palette3[2]) || "#2c8cff"
    }
  }, /*#__PURE__*/React.createElement(GeneratedSlideVisual, {
    slide: slide
  }), /*#__PURE__*/React.createElement("div", {
    className: "slide-copy generated-slide-copy"
  }, /*#__PURE__*/React.createElement("small", null, "Slide ", activeSlide + 1), /*#__PURE__*/React.createElement("h4", null, slide.title), /*#__PURE__*/React.createElement("span", null), /*#__PURE__*/React.createElement("p", null, slide.subtitle)), visibleBullets.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "generated-detail-grid"
  }, visibleBullets.slice(0, 5).map(function (bullet, index) {
    return /*#__PURE__*/React.createElement("div", {
  ...
  })), slide.speakerNotes && /*#__PURE__*/React.createElement("div", {
    className: "generated-notes-strip"
  }, /*#__PURE__*/React.createElement("strong", null, "Speaker Insight"), /*#__PURE__*/React.createElement("span", null, slide.speakerNotes)), slide.visualDirection && /*#__PURE__*/React.createElement("em", {
    className: "generated-visual-note"
  }, slide.visualDirection)), /*#__PURE__*/React.createElement("div", {
    ...
    onClick: function onClick() {
      return setActiveSlide(function (index) {
    ...
    return /*#__PURE__*/React.createElement(SlideThumbnail, {
      key: "".concat(item.title, "-").concat(item.number),
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Slide ", activeSlide + 1, " of ", slides.length), /*#__PURE__*/React.createElement("button", {
    type: "button"
  }, /*#__PURE__*/React.createElement(Icon, {
    icon: Monitor,
    size: 18,
...
function HumanizerMessage(_ref24) {
...
function AISpecifications(_ref27) {
  ...
  return /*#__PURE__*/React.createElement("aside", {
    ...
    onComplete: isCreate ? function (result, prompt) {
      onPresentationGenerated === null || onPresentationGenerated === void 0 || onPresentationGenerated(parseGeneratedPresentation(result.output, prompt, result.deck));
      return {
...
function HumanizerWorkspace(_ref28) {
  ...
  return /*#__PURE__*/React.createElement("main", {
    ...
    mode: mode,
    generatedDeck: mode === "create" ? generatedDeck : null
  }), /*#__PURE__*/React.createElement(AISpecifications, {
    mode: mode,
    onPresentationGenerated: setGeneratedDeck
